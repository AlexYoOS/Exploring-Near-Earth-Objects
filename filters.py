...
Filters that apply to attributes of an instance of CloseApproach:

- date
- distance
- velocity 

 Filters that apply to attributes of an instance of NearEarthObject:
...
# Converted AttributeFilter to Abstract Class as only SuperClass for Filters
class AttributeFilter(ABC):
    ...
    # Converted get method to abstract method as mandatory or SubClass implementation
    @classmethod
    @abstractmethod
...
def create_filters(
    ...
    # Hazardous Subclass and filters (Boolean)
...
def limit(iterator, n=None):
    ...
    """
    # opted to use itertools (import above)
    if n is None or n == 0:
        yield from iterator
    else:
